...
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_102_endBullshit,"GameOverSubstate","endBullshit",0xd9747d97,"GameOverSubstate.endBullshit","GameOverSubstate.hx",102,0x01fbc1e7)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_117_endBullshit,"GameOverSubstate","endBullshit",0xd9747d97,"GameOverSubstate.endBullshit","GameOverSubstate.hx",117,0x01fbc1e7)
...
void GameOverSubstate_obj::endBullshit(){
            		HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_2, ::GameOverSubstate,_gthis) HXARGC(0)
            		void _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_102_endBullshit)
HXLINE( 102)			if (!(_gthis->isEnding)) {
            				HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            				void _hx_run( ::flixel::util::FlxTimer tmr){
            					HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            					void _hx_run(){
            						HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_112_endBullshit)
HXLINE( 112)						 ::flixel::FlxState nextState = ::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::PlayState_obj::__alloc( HX_CTX ,null(),null())) ),false);
...
HXLINE( 110)					::flixel::FlxG_obj::camera->fade(-16777216,2,false, ::Dynamic(new _hx_Closure_0()),null());
            				}
            				HX_END_LOCAL_FUNC1((void))

HXLINE( 104)				_gthis->isEnding = true;
HXLINE( 105)				_gthis->bf->playAnim(HX_("deathConfirm",2c,44,2b,12),true,null(),null());
HXLINE( 106)				{
HXLINE( 106)					 ::flixel::_hx_system::FlxSound _this = ::flixel::FlxG_obj::sound->music;
HXDLIN( 106)					_this->cleanup(_this->autoDestroy,true);
            				}
HXLINE( 107)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd box = ::flixel::FlxG_obj::sound;
HXDLIN( 107)				::String library = null();
HXDLIN( 107)				box->play(::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + (HX_("gameOverEnd",15,2d,a9,8d) + _gthis->stageSuffix)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library),null(),null(),null(),null(),null());
HXLINE( 108)				 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(((Float)0.7), ::Dynamic(new _hx_Closure_1()),null());
            			}
            		}
            		HX_END_LOCAL_FUNC0((void))
            		...
            		void _hx_run(){
            			HX_STACKFRAME(&_hx_pos_b2ae8d30512793fc_117_endBullshit)
            		}
            		HX_END_LOCAL_FUNC0((void))

            	HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_100_endBullshit)
HXDLIN( 100)		 ::GameOverSubstate _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 101)		 ::EASubPayBox box =  ::EASubPayBox_obj::__alloc( HX_CTX ,100,0,::hx::ObjectPtr<OBJ_>(this),HX_("errors cost lol",4b,e0,29,2e),10000,0, ::Dynamic(new _hx_Closure_2(_gthis)), ::Dynamic(new _hx_Closure_3()));
            	}
