...
HX_LOCAL_STACK_FRAME(_hx_pos_18d2ca7c5b2138eb_17_get_component,"io.newgrounds.objects.events._Result.Result_Impl_","get_component",0x7c8cfcb6,"io.newgrounds.objects.events._Result.Result_Impl_.get_component","io/newgrounds/objects/events/Result.hx",17,0xd300c520)
HX_LOCAL_STACK_FRAME(_hx_pos_18d2ca7c5b2138eb_18_get_echo,"io.newgrounds.objects.events._Result.Result_Impl_","get_echo",0x93827d8c,"io.newgrounds.objects.events._Result.Result_Impl_.get_echo","io/newgrounds/objects/events/Result.hx",18,0xd300c520)
HX_LOCAL_STACK_FRAME(_hx_pos_18d2ca7c5b2138eb_19_get_data,"io.newgrounds.objects.events._Result.Result_Impl_","get_data",0x92d7ccd1,"io.newgrounds.objects.events._Result.Result_Impl_.get_data","io/newgrounds/objects/events/Result.hx",19,0xd300c520)
HX_LOCAL_STACK_FRAME(_hx_pos_18d2ca7c5b2138eb_20_get_success,"io.newgrounds.objects.events._Result.Result_Impl_","get_success",0x95ea117c,"io.newgrounds.objects.events._Result.Result_Impl_.get_success","io/newgrounds/objects/events/Result.hx",20,0xd300c520)
HX_LOCAL_STACK_FRAME(_hx_pos_18d2ca7c5b2138eb_21_get_debug,"io.newgrounds.objects.events._Result.Result_Impl_","get_debug",0xec92adcc,"io.newgrounds.objects.events._Result.Result_Impl_.get_debug","io/newgrounds/objects/events/Result.hx",21,0xd300c520)
HX_LOCAL_STACK_FRAME(_hx_pos_18d2ca7c5b2138eb_22_get_error,"io.newgrounds.objects.events._Result.Result_Impl_","get_error",0x889d2741,"io.newgrounds.objects.events._Result.Result_Impl_.get_error","io/newgrounds/objects/events/Result.hx",22,0xd300c520)
namespace io{
...
::String Result_Impl__obj::get_component( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_18d2ca7c5b2138eb_17_get_component)
HXDLIN(  17)		return ( (::String)(this1->__Field(HX_("component",bd,f0,53,0f),::hx::paccDynamic)) );
            	}
...
::String Result_Impl__obj::get_echo( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_18d2ca7c5b2138eb_18_get_echo)
HXDLIN(  18)		return ( (::String)(this1->__Field(HX_("echo",e5,06,0e,43),::hx::paccDynamic)) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Result_Impl__obj,get_echo,return )
 ...
 ::Dynamic Result_Impl__obj::get_data( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_18d2ca7c5b2138eb_19_get_data)
HXDLIN(  19)		return  ::Dynamic(this1->__Field(HX_("data",2a,56,63,42),::hx::paccDynamic));
            	}
...
bool Result_Impl__obj::get_success( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_18d2ca7c5b2138eb_20_get_success)
HXDLIN(  20)		return ( (bool)( ::Dynamic(this1->__Field(HX_("data",2a,56,63,42),::hx::paccDynamic))->__Field(HX_("success",c3,25,4e,b8),::hx::paccDynamic)) );
            	}
...
bool Result_Impl__obj::get_debug( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_18d2ca7c5b2138eb_21_get_debug)
HXDLIN(  21)		return ( (bool)( ::Dynamic(this1->__Field(HX_("data",2a,56,63,42),::hx::paccDynamic))->__Field(HX_("debug",53,52,1f,d7),::hx::paccDynamic)) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Result_Impl__obj,get_debug,return )
 ...
 ::Dynamic Result_Impl__obj::get_error( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_18d2ca7c5b2138eb_22_get_error)
HXDLIN(  22)		return  ::Dynamic(this1->__Field(HX_("data",2a,56,63,42),::hx::paccDynamic))->__Field(HX_("error",c8,cb,29,73),::hx::paccDynamic);
            	}
