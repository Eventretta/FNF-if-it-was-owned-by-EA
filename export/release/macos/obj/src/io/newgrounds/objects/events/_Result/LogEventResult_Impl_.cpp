...
HX_LOCAL_STACK_FRAME(_hx_pos_508ed1c1fdd820da_79_get_event_name,"io.newgrounds.objects.events._Result.LogEventResult_Impl_","get_event_name",0xe46a4961,"io.newgrounds.objects.events._Result.LogEventResult_Impl_.get_event_name","io/newgrounds/objects/events/Result.hx",79,0xd300c520)
HX_LOCAL_STACK_FRAME(_hx_pos_508ed1c1fdd820da_81_get_eventName,"io.newgrounds.objects.events._Result.LogEventResult_Impl_","get_eventName",0xeedc7714,"io.newgrounds.objects.events._Result.LogEventResult_Impl_.get_eventName","io/newgrounds/objects/events/Result.hx",81,0xd300c520)
namespace io{
...
::String LogEventResult_Impl__obj::get_event_name( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_508ed1c1fdd820da_79_get_event_name)
HXDLIN(  79)		return ( (::String)(this1->__Field(HX_("event_name",d0,27,3e,e5),::hx::paccDynamic)) );
            	}
...
::String LogEventResult_Impl__obj::get_eventName( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_508ed1c1fdd820da_81_get_eventName)
HXDLIN(  81)		return ( (::String)(this1->__Field(HX_("event_name",d0,27,3e,e5),::hx::paccDynamic)) );
            	}
