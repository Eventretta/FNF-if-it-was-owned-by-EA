...
HX_LOCAL_STACK_FRAME(_hx_pos_2970e32056b4dc60_46_get_host_approved,"io.newgrounds.objects.events._Result.GetHostResult_Impl_","get_host_approved",0x2f1e24df,"io.newgrounds.objects.events._Result.GetHostResult_Impl_.get_host_approved","io/newgrounds/objects/events/Result.hx",46,0xd300c520)
HX_LOCAL_STACK_FRAME(_hx_pos_2970e32056b4dc60_48_get_hostApproved,"io.newgrounds.objects.events._Result.GetHostResult_Impl_","get_hostApproved",0x5f2c9fae,"io.newgrounds.objects.events._Result.GetHostResult_Impl_.get_hostApproved","io/newgrounds/objects/events/Result.hx",48,0xd300c520)
namespace io{
...
bool GetHostResult_Impl__obj::get_host_approved( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_2970e32056b4dc60_46_get_host_approved)
HXDLIN(  46)		return ( (bool)(this1->__Field(HX_("host_approved",6e,49,52,b8),::hx::paccDynamic)) );
            	}
...
bool GetHostResult_Impl__obj::get_hostApproved( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_2970e32056b4dc60_48_get_hostApproved)
HXDLIN(  48)		return ( (bool)(this1->__Field(HX_("host_approved",6e,49,52,b8),::hx::paccDynamic)) );
            	}
