...
HX_LOCAL_STACK_FRAME(_hx_pos_f4605c69a0ee53a1_59_get_current_version,"io.newgrounds.objects.events._Result.GetCurrentVersionResult_Impl_","get_current_version",0x87e211ba,"io.newgrounds.objects.events._Result.GetCurrentVersionResult_Impl_.get_current_version","io/newgrounds/objects/events/Result.hx",59,0xd300c520)
HX_LOCAL_STACK_FRAME(_hx_pos_f4605c69a0ee53a1_61_get_currentVersion,"io.newgrounds.objects.events._Result.GetCurrentVersionResult_Impl_","get_currentVersion",0x5c6b7cf7,"io.newgrounds.objects.events._Result.GetCurrentVersionResult_Impl_.get_currentVersion","io/newgrounds/objects/events/Result.hx",61,0xd300c520)
HX_LOCAL_STACK_FRAME(_hx_pos_f4605c69a0ee53a1_65_get_client_deprecated,"io.newgrounds.objects.events._Result.GetCurrentVersionResult_Impl_","get_client_deprecated",0x3b74fe0f,"io.newgrounds.objects.events._Result.GetCurrentVersionResult_Impl_.get_client_deprecated","io/newgrounds/objects/events/Result.hx",65,0xd300c520)
HX_LOCAL_STACK_FRAME(_hx_pos_f4605c69a0ee53a1_67_get_clientDeprecated,"io.newgrounds.objects.events._Result.GetCurrentVersionResult_Impl_","get_clientDeprecated",0x4def50b6,"io.newgrounds.objects.events._Result.GetCurrentVersionResult_Impl_.get_clientDeprecated","io/newgrounds/objects/events/Result.hx",67,0xd300c520)
namespace io{
...
::String GetCurrentVersionResult_Impl__obj::get_current_version( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_f4605c69a0ee53a1_59_get_current_version)
HXDLIN(  59)		return ( (::String)(this1->__Field(HX_("current_version",d2,3d,4a,b1),::hx::paccDynamic)) );
            	}
...
::String GetCurrentVersionResult_Impl__obj::get_currentVersion( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_f4605c69a0ee53a1_61_get_currentVersion)
HXDLIN(  61)		return ( (::String)(this1->__Field(HX_("current_version",d2,3d,4a,b1),::hx::paccDynamic)) );
            	}
...
bool GetCurrentVersionResult_Impl__obj::get_client_deprecated( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_f4605c69a0ee53a1_65_get_client_deprecated)
HXDLIN(  65)		return ( (bool)(this1->__Field(HX_("client_deprecated",27,60,52,b0),::hx::paccDynamic)) );
            	}
...
bool GetCurrentVersionResult_Impl__obj::get_clientDeprecated( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_f4605c69a0ee53a1_67_get_clientDeprecated)
HXDLIN(  67)		return ( (bool)(this1->__Field(HX_("client_deprecated",27,60,52,b0),::hx::paccDynamic)) );
            	}
