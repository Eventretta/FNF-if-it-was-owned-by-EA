...
HX_LOCAL_STACK_FRAME(_hx_pos_5505b1367d794a0e_92_get_datetime,"io.newgrounds.objects.events._Result.GetDateTimeResult_Impl_","get_datetime",0x59d0c397,"io.newgrounds.objects.events._Result.GetDateTimeResult_Impl_.get_datetime","io/newgrounds/objects/events/Result.hx",92,0xd300c520)
HX_LOCAL_STACK_FRAME(_hx_pos_5505b1367d794a0e_94_get_dateTime,"io.newgrounds.objects.events._Result.GetDateTimeResult_Impl_","get_dateTime",0x44a9efb7,"io.newgrounds.objects.events._Result.GetDateTimeResult_Impl_.get_dateTime","io/newgrounds/objects/events/Result.hx",94,0xd300c520)
namespace io{
...
::String GetDateTimeResult_Impl__obj::get_datetime( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_5505b1367d794a0e_92_get_datetime)
HXDLIN(  92)		return ( (::String)(this1->__Field(HX_("datetime",3b,d1,31,ef),::hx::paccDynamic)) );
            	}
...
::String GetDateTimeResult_Impl__obj::get_dateTime( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_5505b1367d794a0e_94_get_dateTime)
HXDLIN(  94)		return ( (::String)(this1->__Field(HX_("datetime",3b,d1,31,ef),::hx::paccDynamic)) );
            	}
