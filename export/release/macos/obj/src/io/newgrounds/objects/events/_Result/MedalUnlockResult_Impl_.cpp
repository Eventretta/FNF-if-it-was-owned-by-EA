...
HX_LOCAL_STACK_FRAME(_hx_pos_93848e41f576495d_120_get_medal_score,"io.newgrounds.objects.events._Result.MedalUnlockResult_Impl_","get_medal_score",0x46c6bdf8,"io.newgrounds.objects.events._Result.MedalUnlockResult_Impl_.get_medal_score","io/newgrounds/objects/events/Result.hx",120,0xd300c520)
HX_LOCAL_STACK_FRAME(_hx_pos_93848e41f576495d_122_get_medalScore,"io.newgrounds.objects.events._Result.MedalUnlockResult_Impl_","get_medalScore",0x29ab136d,"io.newgrounds.objects.events._Result.MedalUnlockResult_Impl_.get_medalScore","io/newgrounds/objects/events/Result.hx",122,0xd300c520)
namespace io{
...
::String MedalUnlockResult_Impl__obj::get_medal_score( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_93848e41f576495d_120_get_medal_score)
HXDLIN( 120)		return ( (::String)(this1->__Field(HX_("medal_score",ca,0b,4e,ce),::hx::paccDynamic)) );
            	}
...
::String MedalUnlockResult_Impl__obj::get_medalScore( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_93848e41f576495d_122_get_medalScore)
HXDLIN( 122)		return ( (::String)(this1->__Field(HX_("medal_score",ca,0b,4e,ce),::hx::paccDynamic)) );
            	}
