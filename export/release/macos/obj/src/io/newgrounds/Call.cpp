...
HXDLIN( 169)		::io::newgrounds::utils::AsyncNGCall_obj::send(_hx_tmp1,::haxe::format::JsonPrinter_obj::print(data,replacer1,space1),this->onData_dyn(),this->onHttpError_dyn(),this->onStatus_dyn());
            	}
