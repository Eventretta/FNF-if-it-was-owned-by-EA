...
HX_DEFINE_STACK_FRAME(_hx_pos_f54da57cc2a963a3_21_new,"io.newgrounds.components.ComponentList","new",0xbe2cae2f,"io.newgrounds.components.ComponentList.new","io/newgrounds/components/ComponentList.hx",21,0xdc173482)
namespace io{
namespace newgrounds{
namespace components{

void ComponentList_obj::__construct( ::io::newgrounds::NGLite core){
            	HX_GC_STACKFRAME(&_hx_pos_f54da57cc2a963a3_21_new)
HXLINE(  23)		this->_core = core;
HXLINE(  25)		this->app =  ::io::newgrounds::components::AppComponent_obj::__alloc( HX_CTX ,this->_core);
HXLINE(  26)		this->cloudSave =  ::io::newgrounds::components::CloudSaveComponent_obj::__alloc( HX_CTX ,this->_core);
HXLINE(  27)		this->event =  ::io::newgrounds::components::EventComponent_obj::__alloc( HX_CTX ,this->_core);
HXLINE(  28)		this->gateway =  ::io::newgrounds::components::GatewayComponent_obj::__alloc( HX_CTX ,this->_core);
HXLINE(  29)		this->loader =  ::io::newgrounds::components::LoaderComponent_obj::__alloc( HX_CTX ,this->_core);
HXLINE(  30)		this->medal =  ::io::newgrounds::components::MedalComponent_obj::__alloc( HX_CTX ,this->_core);
HXLINE(  31)		this->scoreBoard =  ::io::newgrounds::components::ScoreBoardComponent_obj::__alloc( HX_CTX ,this->_core);
            	}
...
void ComponentList_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(cloudSave,"cloudSave");
...
void ComponentList_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(cloudSave,"cloudSave");
...
::hx::Val ComponentList_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"cloudSave") ) { return ::hx::Val( cloudSave ); }
		break;
	case 10:
...
::hx::Val ComponentList_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"cloudSave") ) { cloudSave=inValue.Cast<  ::io::newgrounds::components::CloudSaveComponent >(); return inValue; }
		break;
	case 10:
...
void ComponentList_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("cloudSave",52,2f,6c,4f));
...
static ::hx::StorageInfo ComponentList_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::io::newgrounds::components::CloudSaveComponent */ ,(int)offsetof(ComponentList_obj,cloudSave),HX_("cloudSave",52,2f,6c,4f)},
