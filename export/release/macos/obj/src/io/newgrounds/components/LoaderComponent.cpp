...
HX_DEFINE_STACK_FRAME(_hx_pos_00e1f7847e9f2f74_15_new,"io.newgrounds.components.LoaderComponent","new",0xdf59289e,"io.newgrounds.components.LoaderComponent.new","io/newgrounds/components/LoaderComponent.hx",15,0xde01b733)
HX_LOCAL_STACK_FRAME(_hx_pos_00e1f7847e9f2f74_19_loadAuthorUrl,"io.newgrounds.components.LoaderComponent","loadAuthorUrl",0x97db045c,"io.newgrounds.components.LoaderComponent.loadAuthorUrl","io/newgrounds/components/LoaderComponent.hx",19,0xde01b733)
HX_LOCAL_STACK_FRAME(_hx_pos_00e1f7847e9f2f74_26_loadMoreGames,"io.newgrounds.components.LoaderComponent","loadMoreGames",0x8a8e9724,"io.newgrounds.components.LoaderComponent.loadMoreGames","io/newgrounds/components/LoaderComponent.hx",26,0xde01b733)
HX_LOCAL_STACK_FRAME(_hx_pos_00e1f7847e9f2f74_33_loadNewgrounds,"io.newgrounds.components.LoaderComponent","loadNewgrounds",0xec7e4df4,"io.newgrounds.components.LoaderComponent.loadNewgrounds","io/newgrounds/components/LoaderComponent.hx",33,0xde01b733)
HX_LOCAL_STACK_FRAME(_hx_pos_00e1f7847e9f2f74_40_loadOfficialUrl,"io.newgrounds.components.LoaderComponent","loadOfficialUrl",0x58442cbc,"io.newgrounds.components.LoaderComponent.loadOfficialUrl","io/newgrounds/components/LoaderComponent.hx",40,0xde01b733)
HX_LOCAL_STACK_FRAME(_hx_pos_00e1f7847e9f2f74_47_loadReferral,"io.newgrounds.components.LoaderComponent","loadReferral",0x9900d5a5,"io.newgrounds.components.LoaderComponent.loadReferral","io/newgrounds/components/LoaderComponent.hx",47,0xde01b733)
namespace io{
namespace newgrounds{
namespace components{

void LoaderComponent_obj::__construct( ::io::newgrounds::NGLite core){
            	HX_STACKFRAME(&_hx_pos_00e1f7847e9f2f74_15_new)
HXDLIN(  15)		super::__construct(core);
            	}
...
bool LoaderComponent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::io::newgrounds::Call LoaderComponent_obj::loadAuthorUrl(::hx::Null< bool >  __o_redirect){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_00e1f7847e9f2f74_19_loadAuthorUrl)
HXDLIN(  19)		return  ::io::newgrounds::Call_obj::__alloc( HX_CTX ,this->_core,HX_("Loader.loadAuthorUrl",23,3d,b4,d4),null(),null())->addComponentParameter(HX_("host",68,cf,12,45),this->_core->host,null())->addComponentParameter(HX_("redirect",1c,f7,d8,9c),redirect,true);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(LoaderComponent_obj,loadAuthorUrl,return )
 ...
 ::io::newgrounds::Call LoaderComponent_obj::loadMoreGames(::hx::Null< bool >  __o_redirect){
            		bool redirect = __o_redirect.Default(false);
            	HX_GC_STACKFRAME(&_hx_pos_00e1f7847e9f2f74_26_loadMoreGames)
HXDLIN(  26)		return  ::io::newgrounds::Call_obj::__alloc( HX_CTX ,this->_core,HX_("Loader.loadMoreGames",eb,cf,67,c7),null(),null())->addComponentParameter(HX_("host",68,cf,12,45),this->_core->host,null())->addComponentParameter(HX_("redirect",1c,f7,d8,9c),redirect,true);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(LoaderComponent_obj,loadMoreGames,return )
 ...
 ::io::newgrounds::Call LoaderComponent_obj::loadNewgrounds(::hx::Null< bool >  __o_redirect){
            		bool redirect = __o_redirect.Default(false);
            	HX_GC_STACKFRAME(&_hx_pos_00e1f7847e9f2f74_33_loadNewgrounds)
HXDLIN(  33)		return  ::io::newgrounds::Call_obj::__alloc( HX_CTX ,this->_core,HX_("Loader.loadNewgrounds",4d,c3,b6,ed),null(),null())->addComponentParameter(HX_("host",68,cf,12,45),this->_core->host,null())->addComponentParameter(HX_("redirect",1c,f7,d8,9c),redirect,true);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(LoaderComponent_obj,loadNewgrounds,return )
 ...
 ::io::newgrounds::Call LoaderComponent_obj::loadOfficialUrl(::hx::Null< bool >  __o_redirect){
            		bool redirect = __o_redirect.Default(false);
            	HX_GC_STACKFRAME(&_hx_pos_00e1f7847e9f2f74_40_loadOfficialUrl)
HXDLIN(  40)		return  ::io::newgrounds::Call_obj::__alloc( HX_CTX ,this->_core,HX_("Loader.loadOfficialUrl",43,65,72,68),null(),null())->addComponentParameter(HX_("host",68,cf,12,45),this->_core->host,null())->addComponentParameter(HX_("redirect",1c,f7,d8,9c),redirect,true);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(LoaderComponent_obj,loadOfficialUrl,return )
 ...
 ::io::newgrounds::Call LoaderComponent_obj::loadReferral(::hx::Null< bool >  __o_redirect){
            		bool redirect = __o_redirect.Default(false);
            	HX_GC_STACKFRAME(&_hx_pos_00e1f7847e9f2f74_47_loadReferral)
HXDLIN(  47)		return  ::io::newgrounds::Call_obj::__alloc( HX_CTX ,this->_core,HX_("Loader.loadReferral",be,12,dd,bc),null(),null())->addComponentParameter(HX_("host",68,cf,12,45),this->_core->host,null())->addComponentParameter(HX_("redirect",1c,f7,d8,9c),redirect,true);
            	}
