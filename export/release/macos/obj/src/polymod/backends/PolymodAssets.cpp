...
HX_LOCAL_STACK_FRAME(_hx_pos_5b88a33584460d08_92_init,"polymod.backends.PolymodAssets","init",0x336e0b5c,"polymod.backends.PolymodAssets.init","polymod/backends/PolymodAssets.hx",92,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_5b88a33584460d08_175_exists,"polymod.backends.PolymodAssets","exists",0x9c209928,"polymod.backends.PolymodAssets.exists","polymod/backends/PolymodAssets.hx",175,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_5b88a33584460d08_180_getBytes,"polymod.backends.PolymodAssets","getBytes",0xe73dfe41,"polymod.backends.PolymodAssets.getBytes","polymod/backends/PolymodAssets.hx",180,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_5b88a33584460d08_185_getText,"polymod.backends.PolymodAssets","getText",0xfba7e397,"polymod.backends.PolymodAssets.getText","polymod/backends/PolymodAssets.hx",185,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_5b88a33584460d08_190_getPath,"polymod.backends.PolymodAssets","getPath",0xf8fffc8f,"polymod.backends.PolymodAssets.getPath","polymod/backends/PolymodAssets.hx",190,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_5b88a33584460d08_195_list,"polymod.backends.PolymodAssets","list",0x3565ecaa,"polymod.backends.PolymodAssets.list","polymod/backends/PolymodAssets.hx",195,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_5b88a33584460d08_218_autoDetectFramework,"polymod.backends.PolymodAssets","autoDetectFramework",0x6c71ec20,"polymod.backends.PolymodAssets.autoDetectFramework","polymod/backends/PolymodAssets.hx",218,0xd8b6783c)
namespace polymod{
namespace backends{
...
bool PolymodAssets_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::polymod::backends::PolymodAssetLibrary PolymodAssets_obj::init( ::Dynamic params){
            	HX_GC_STACKFRAME(&_hx_pos_5b88a33584460d08_92_init)
HXLINE(  93)		 ::polymod::Framework framework = params->__Field(HX_("framework",7e,94,a4,51),::hx::paccDynamic);
HXLINE(  94)		if (::hx::IsNull( framework )) {
HXLINE(  96)			framework = ::polymod::backends::PolymodAssets_obj::autoDetectFramework();
HXLINE(  97)			::polymod::Polymod_obj::notice(HX_("framework_autodetect",73,b0,56,0a),(HX_("Framework: Autodetect, going with ",0a,5c,6f,fa) + ::Std_obj::string(framework)),null());
            		}
            		else {
HXLINE( 101)			::polymod::Polymod_obj::notice(HX_("framework_init",b1,b9,06,67),(HX_("Framework: User specified ",81,e2,12,71) + ::Std_obj::string(framework)),null());
            		}
HXLINE( 103)		::Dynamic backend;
HXDLIN( 103)		switch((int)(framework->_hx_getIndex())){
            			case (int)0: {
HXLINE( 103)				backend =  ::polymod::backends::CastleBackend_obj::__alloc( HX_CTX );
            			}
            			break;
            			case (int)1: {
HXLINE( 103)				backend =  ::polymod::backends::NMEBackend_obj::__alloc( HX_CTX );
            			}
            			break;
            			case (int)2: {
HXLINE( 103)				backend =  ::polymod::backends::LimeBackend_obj::__alloc( HX_CTX );
            			}
            			break;
            			case (int)3: {
HXLINE( 103)				backend =  ::polymod::backends::OpenFLBackend_obj::__alloc( HX_CTX );
            			}
            			break;
            			case (int)4: {
HXLINE( 103)				backend =  ::polymod::backends::OpenFLWithNodeBackend_obj::__alloc( HX_CTX );
            			}
            			break;
            			case (int)5: {
HXLINE( 103)				backend =  ::polymod::backends::FlixelBackend_obj::__alloc( HX_CTX );
            			}
            			break;
            			case (int)6: {
HXLINE( 103)				backend =  ::polymod::backends::HEAPSBackend_obj::__alloc( HX_CTX );
            			}
            			break;
            			case (int)7: {
HXLINE( 103)				backend =  ::polymod::backends::KhaBackend_obj::__alloc( HX_CTX );
            			}
            			break;
            			case (int)8: {
HXLINE( 114)				if (::hx::IsNotNull( params->__Field(HX_("customBackend",63,24,96,a5),::hx::paccDynamic) )) {
HXLINE( 103)					backend = ::Type_obj::createInstance(params->__Field(HX_("customBackend",63,24,96,a5),::hx::paccDynamic),::cpp::VirtualArray_obj::__new(0));
            				}
            				else {
HXLINE( 120)					::polymod::Polymod_obj::error(HX_("undefined_custom_backend",55,22,be,1a),HX_("params.customBackend was not defined!",c1,92,8f,a0),null());
HXLINE( 103)					backend = null();
            				}
            			}
            			break;
            			default:{
...
HXLINE( 125)		if (::hx::IsNull( backend )) {
HXLINE( 127)			::polymod::Polymod_obj::error(HX_("failed_create_backend",13,58,1e,db),((HX_("could not create a backend for framework(",04,e6,ea,e7) + ::Std_obj::string(framework)) + HX_(")!",d8,23,00,00)),null());
HXLINE( 128)			return null();
            		}
HXLINE( 145)		if (::hx::IsNotNull( ::polymod::backends::PolymodAssets_obj::library )) {
HXLINE( 147)			::polymod::backends::PolymodAssets_obj::library->destroy();
            		}
HXLINE( 150)		::polymod::backends::PolymodAssets_obj::library =  ::polymod::backends::PolymodAssetLibrary_obj::__alloc( HX_CTX , ::Dynamic(::hx::Anon_obj::Create(6)
...
HXLINE( 162)		if (::polymod::backends::IBackend_obj::init(backend, ::Dynamic(params->__Field(HX_("frameworkParams",64,76,eb,26),::hx::paccDynamic)))) {
HXLINE( 165)			return ::polymod::backends::PolymodAssets_obj::library;
            		}
            		else {
...
bool PolymodAssets_obj::exists(::String id){
            	HX_STACKFRAME(&_hx_pos_5b88a33584460d08_175_exists)
HXDLIN( 175)		return ::polymod::backends::PolymodAssets_obj::library->exists(id);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(PolymodAssets_obj,exists,return )
 ...
 ::haxe::io::Bytes PolymodAssets_obj::getBytes(::String id){
            	HX_STACKFRAME(&_hx_pos_5b88a33584460d08_180_getBytes)
HXDLIN( 180)		return ::polymod::backends::PolymodAssets_obj::library->getBytes(id);
            	}
...
::String PolymodAssets_obj::getText(::String id){
            	HX_STACKFRAME(&_hx_pos_5b88a33584460d08_185_getText)
HXDLIN( 185)		return ::polymod::backends::PolymodAssets_obj::library->getText(id);
            	}
...
::String PolymodAssets_obj::getPath(::String id){
            	HX_STACKFRAME(&_hx_pos_5b88a33584460d08_190_getPath)
HXDLIN( 190)		return ::polymod::backends::PolymodAssets_obj::library->getPath(id);
            	}
...
::Array< ::String > PolymodAssets_obj::list(::String type){
            	HX_STACKFRAME(&_hx_pos_5b88a33584460d08_195_list)
HXDLIN( 195)		return ::polymod::backends::PolymodAssets_obj::library->list(type);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(PolymodAssets_obj,list,return )
 ...
 ::polymod::Framework PolymodAssets_obj::autoDetectFramework(){
            	HX_STACKFRAME(&_hx_pos_5b88a33584460d08_218_autoDetectFramework)
HXDLIN( 218)		return ::polymod::Framework_obj::FLIXEL_dyn();
            	}
