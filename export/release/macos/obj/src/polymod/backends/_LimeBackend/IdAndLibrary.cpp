...
HX_DEFINE_STACK_FRAME(_hx_pos_04fa384cfca16a40_744_new,"polymod.backends._LimeBackend.IdAndLibrary","new",0x62fe42a8,"polymod.backends._LimeBackend.IdAndLibrary.new","polymod/backends/LimeBackend.hx",744,0xcff7dfd6)
namespace polymod{
namespace backends{
...
void IdAndLibrary_obj::__construct(::String id, ::haxe::ds::StringMap libs, ::polymod::backends::LimeModLibrary l){
            	HX_STACKFRAME(&_hx_pos_04fa384cfca16a40_744_new)
HXLINE( 745)		this->fallbackId = id;
HXLINE( 746)		int colonIndex = id.indexOf(HX_(":",3a,00,00,00),null());
HXLINE( 747)		this->lib = id.substring(0,colonIndex);
HXLINE( 748)		this->nakedId = id.substring((colonIndex + 1),null());
HXLINE( 749)		if (::hx::IsNotNull( l )) {
HXLINE( 751)			this->library = l;
            		}
            		else {
HXLINE( 753)			if (::hx::IsNotNull( libs )) {
HXLINE( 755)				bool _hx_tmp;
HXDLIN( 755)				if ((this->lib != HX_("",00,00,00,00))) {
HXLINE( 755)					_hx_tmp = ::hx::IsNull( this->lib );
            				}
            				else {
HXLINE( 755)					_hx_tmp = true;
            				}
HXDLIN( 755)				if (_hx_tmp) {
HXLINE( 757)					this->lib = HX_("default",c1,d8,c3,9b);
            				}
HXLINE( 759)				this->library = ( ( ::polymod::backends::LimeModLibrary)(libs->get(this->lib)) );
            			}
            		}
HXLINE( 761)		bool _hx_tmp;
HXDLIN( 761)		bool _hx_tmp1;
HXDLIN( 761)		if (::hx::IsNotNull( this->library )) {
HXLINE( 761)			_hx_tmp1 = ::hx::IsNotNull( this->library->pathPrefix );
            		}
            		else {
HXLINE( 761)			_hx_tmp1 = false;
            		}
HXDLIN( 761)		if (_hx_tmp1) {
HXLINE( 761)			_hx_tmp = (this->library->pathPrefix != HX_("",00,00,00,00));
            		}
            		else {
HXLINE( 761)			_hx_tmp = false;
            		}
HXDLIN( 761)		if (_hx_tmp) {
HXLINE( 763)			this->modId = ((this->library->pathPrefix + HX_("/",2f,00,00,00)) + this->nakedId);
            		}
HXLINE( 765)		this->modId = this->nakedId;
            	}
