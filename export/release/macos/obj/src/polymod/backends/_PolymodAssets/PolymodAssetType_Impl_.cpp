...
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_248_fromString,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","fromString",0xa9047b18,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.fromString","polymod/backends/PolymodAssets.hx",248,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_235_boot,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","boot",0x35ee15af,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.boot","polymod/backends/PolymodAssets.hx",235,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_236_boot,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","boot",0x35ee15af,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.boot","polymod/backends/PolymodAssets.hx",236,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_237_boot,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","boot",0x35ee15af,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.boot","polymod/backends/PolymodAssets.hx",237,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_238_boot,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","boot",0x35ee15af,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.boot","polymod/backends/PolymodAssets.hx",238,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_239_boot,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","boot",0x35ee15af,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.boot","polymod/backends/PolymodAssets.hx",239,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_240_boot,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","boot",0x35ee15af,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.boot","polymod/backends/PolymodAssets.hx",240,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_241_boot,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","boot",0x35ee15af,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.boot","polymod/backends/PolymodAssets.hx",241,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_242_boot,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","boot",0x35ee15af,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.boot","polymod/backends/PolymodAssets.hx",242,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_243_boot,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","boot",0x35ee15af,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.boot","polymod/backends/PolymodAssets.hx",243,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_244_boot,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","boot",0x35ee15af,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.boot","polymod/backends/PolymodAssets.hx",244,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_245_boot,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","boot",0x35ee15af,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.boot","polymod/backends/PolymodAssets.hx",245,0xd8b6783c)
namespace polymod{
namespace backends{
...
::String PolymodAssetType_Impl__obj::fromString(::String str){
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_248_fromString)
HXLINE( 249)		str = str.toUpperCase();
HXLINE( 250)		::String _hx_switch_0 = str;
...
HXLINE( 253)			return str;
HXDLIN( 253)			goto _hx_goto_0;
            		}
            		/* default */{
HXLINE( 255)			return HX_("UNKNOWN",6a,f7,4e,61);
            		}
            		_hx_goto_0:;
...
{
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_235_boot)
HXDLIN( 235)		BYTES = HX_("BYTES",4b,40,86,3b);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_236_boot)
HXDLIN( 236)		TEXT = HX_("TEXT",ad,94,ba,37);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_237_boot)
HXDLIN( 237)		IMAGE = HX_("IMAGE",3b,57,57,3b);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_238_boot)
HXDLIN( 238)		VIDEO = HX_("VIDEO",5b,4c,ea,b4);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_239_boot)
HXDLIN( 239)		FONT = HX_("FONT",cf,25,81,2e);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_240_boot)
HXDLIN( 240)		AUDIO_GENERIC = HX_("AUDIO_GENERIC",2e,f6,26,23);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_241_boot)
HXDLIN( 241)		AUDIO_MUSIC = HX_("AUDIO_MUSIC",fc,6c,05,48);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_242_boot)
HXDLIN( 242)		AUDIO_SOUND = HX_("AUDIO_SOUND",26,29,77,b8);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_243_boot)
HXDLIN( 243)		MANIFEST = HX_("MANIFEST",af,8b,af,29);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_244_boot)
HXDLIN( 244)		TEMPLATE = HX_("TEMPLATE",3a,78,cd,05);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_245_boot)
HXDLIN( 245)		UNKNOWN = HX_("UNKNOWN",6a,f7,4e,61);
            	}
}
