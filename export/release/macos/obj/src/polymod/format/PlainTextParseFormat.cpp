...
HX_LOCAL_STACK_FRAME(_hx_pos_19ba14b2e25efefe_1050_parse,"polymod.format.PlainTextParseFormat","parse",0xefd79e37,"polymod.format.PlainTextParseFormat.parse","polymod/format/ParseRules.hx",1050,0xc5c5c43b)
...
HX_LOCAL_STACK_FRAME(_hx_pos_19ba14b2e25efefe_1088_print,"polymod.format.PlainTextParseFormat","print",0xfb0d6631,"polymod.format.PlainTextParseFormat.print","polymod/format/ParseRules.hx",1088,0xc5c5c43b)
namespace polymod{
namespace format{
...
::String PlainTextParseFormat_obj::parse(::String str){
            	HX_STACKFRAME(&_hx_pos_19ba14b2e25efefe_1050_parse)
HXDLIN(1050)		return str;
            	}
...
::String PlainTextParseFormat_obj::print(::String str){
            	HX_STACKFRAME(&_hx_pos_19ba14b2e25efefe_1088_print)
HXDLIN(1088)		return str;
            	}
