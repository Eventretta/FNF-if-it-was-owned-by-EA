...
HX_DEFINE_STACK_FRAME(_hx_pos_bfb78df8014a2c60_654_new,"polymod.PolymodError","new",0xa579457c,"polymod.PolymodError.new","polymod/Polymod.hx",654,0xd80c6d61)
namespace polymod{

void PolymodError_obj::__construct( ::polymod::PolymodErrorType severity,::String code,::String message,::String origin){
            	HX_STACKFRAME(&_hx_pos_bfb78df8014a2c60_654_new)
HXLINE( 655)		this->severity = severity;
HXLINE( 656)		this->code = code;
HXLINE( 657)		this->message = message;
HXLINE( 658)		this->origin = origin;
            	}
