...
HX_LOCAL_STACK_FRAME(_hx_pos_cae42745e4bfdcf9_99_get_scriptLibrary,"polymod.PolymodConfig","get_scriptLibrary",0x2f4f2459,"polymod.PolymodConfig.get_scriptLibrary","polymod/PolymodConfig.hx",99,0x8e4837ff)
HX_LOCAL_STACK_FRAME(_hx_pos_cae42745e4bfdcf9_117_get_appendFolder,"polymod.PolymodConfig","get_appendFolder",0xb5fda81f,"polymod.PolymodConfig.get_appendFolder","polymod/PolymodConfig.hx",117,0x8e4837ff)
HX_LOCAL_STACK_FRAME(_hx_pos_cae42745e4bfdcf9_141_get_apiVersionMatch,"polymod.PolymodConfig","get_apiVersionMatch",0x1d4f7b30,"polymod.PolymodConfig.get_apiVersionMatch","polymod/PolymodConfig.hx",141,0x8e4837ff)
HX_LOCAL_STACK_FRAME(_hx_pos_cae42745e4bfdcf9_159_get_useHScriptEX,"polymod.PolymodConfig","get_useHScriptEX",0x27173676,"polymod.PolymodConfig.get_useHScriptEX","polymod/PolymodConfig.hx",159,0x8e4837ff)
...
HX_LOCAL_STACK_FRAME(_hx_pos_cae42745e4bfdcf9_195_get_modPackFile,"polymod.PolymodConfig","get_modPackFile",0x99ed06c0,"polymod.PolymodConfig.get_modPackFile","polymod/PolymodConfig.hx",195,0x8e4837ff)
HX_LOCAL_STACK_FRAME(_hx_pos_cae42745e4bfdcf9_213_get_modMetadataFile,"polymod.PolymodConfig","get_modMetadataFile",0xc9a9dbd6,"polymod.PolymodConfig.get_modMetadataFile","polymod/PolymodConfig.hx",213,0x8e4837ff)
HX_LOCAL_STACK_FRAME(_hx_pos_cae42745e4bfdcf9_231_get_modIconFile,"polymod.PolymodConfig","get_modIconFile",0xe332e760,"polymod.PolymodConfig.get_modIconFile","polymod/PolymodConfig.hx",231,0x8e4837ff)
HX_LOCAL_STACK_FRAME(_hx_pos_cae42745e4bfdcf9_250_get_modIgnoreFiles,"polymod.PolymodConfig","get_modIgnoreFiles",0xad36f01a,"polymod.PolymodConfig.get_modIgnoreFiles","polymod/PolymodConfig.hx",250,0x8e4837ff)
...
HX_LOCAL_STACK_FRAME(_hx_pos_cae42745e4bfdcf9_138_boot,"polymod.PolymodConfig","boot",0xd1baa6a0,"polymod.PolymodConfig.boot","polymod/PolymodConfig.hx",138,0x8e4837ff)
...
::String PolymodConfig_obj::get_scriptLibrary(){
            	HX_STACKFRAME(&_hx_pos_cae42745e4bfdcf9_99_get_scriptLibrary)
HXLINE( 101)		if (::hx::IsNull( ::polymod::PolymodConfig_obj::scriptLibrary )) {
HXLINE( 102)			::polymod::PolymodConfig_obj::scriptLibrary = HX_("default",c1,d8,c3,9b);
            		}
HXLINE( 103)		return ::polymod::PolymodConfig_obj::scriptLibrary;
            	}
...
::String PolymodConfig_obj::get_appendFolder(){
            	HX_STACKFRAME(&_hx_pos_cae42745e4bfdcf9_117_get_appendFolder)
HXLINE( 119)		if (::hx::IsNull( ::polymod::PolymodConfig_obj::appendFolder )) {
HXLINE( 120)			::polymod::PolymodConfig_obj::appendFolder = HX_("_append",79,f3,4a,fe);
            		}
HXLINE( 121)		return ::polymod::PolymodConfig_obj::appendFolder;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(PolymodConfig_obj,get_appendFolder,return )
 ...
 ::Dynamic PolymodConfig_obj::get_apiVersionMatch(){
            	HX_STACKFRAME(&_hx_pos_cae42745e4bfdcf9_141_get_apiVersionMatch)
HXLINE( 143)		if (::hx::IsNull( ::polymod::PolymodConfig_obj::apiVersionMatch )) {
HXLINE( 144)			::polymod::PolymodConfig_obj::apiVersionMatch = ::polymod::util::_SemanticVersion::SemanticVersionScore_Impl__obj::fromString(HX_("MATCH_PATCH",ce,f0,6e,ae));
            		}
HXLINE( 145)		return ::polymod::PolymodConfig_obj::apiVersionMatch;
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC0(PolymodConfig_obj,get_apiVersionMatch,return )

 ::Dynamic PolymodConfig_obj::useHScriptEX;

 ::Dynamic PolymodConfig_obj::get_useHScriptEX(){
            	HX_STACKFRAME(&_hx_pos_cae42745e4bfdcf9_159_get_useHScriptEX)
HXLINE( 161)		if (::hx::IsNull( ::polymod::PolymodConfig_obj::useHScriptEX )) {
HXLINE( 162)			::polymod::PolymodConfig_obj::useHScriptEX = false;
            		}
HXLINE( 163)		return ::polymod::PolymodConfig_obj::useHScriptEX;
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC0(PolymodConfig_obj,get_useHScriptEX,return )
...
::String PolymodConfig_obj::get_modPackFile(){
            	HX_STACKFRAME(&_hx_pos_cae42745e4bfdcf9_195_get_modPackFile)
HXLINE( 197)		if (::hx::IsNull( ::polymod::PolymodConfig_obj::modPackFile )) {
HXLINE( 198)			::polymod::PolymodConfig_obj::modPackFile = HX_("_polymod_pack.txt",63,9d,09,cb);
            		}
HXLINE( 199)		return ::polymod::PolymodConfig_obj::modPackFile;
            	}
...
::String PolymodConfig_obj::get_modMetadataFile(){
            	HX_STACKFRAME(&_hx_pos_cae42745e4bfdcf9_213_get_modMetadataFile)
HXLINE( 215)		if (::hx::IsNull( ::polymod::PolymodConfig_obj::modMetadataFile )) {
HXLINE( 216)			::polymod::PolymodConfig_obj::modMetadataFile = HX_("_polymod_meta.json",69,fc,10,06);
            		}
HXLINE( 217)		return ::polymod::PolymodConfig_obj::modMetadataFile;
            	}
...
::String PolymodConfig_obj::get_modIconFile(){
            	HX_STACKFRAME(&_hx_pos_cae42745e4bfdcf9_231_get_modIconFile)
HXLINE( 233)		if (::hx::IsNull( ::polymod::PolymodConfig_obj::modIconFile )) {
HXLINE( 234)			::polymod::PolymodConfig_obj::modIconFile = HX_("_polymod_icon.png",3c,6c,4c,14);
            		}
HXLINE( 235)		return ::polymod::PolymodConfig_obj::modIconFile;
            	}
...
::Array< ::String > PolymodConfig_obj::get_modIgnoreFiles(){
            	HX_STACKFRAME(&_hx_pos_cae42745e4bfdcf9_250_get_modIgnoreFiles)
HXLINE( 252)		if (::hx::IsNull( ::polymod::PolymodConfig_obj::modIgnoreFiles )) {
HXLINE( 253)			::polymod::PolymodConfig_obj::modIgnoreFiles = ::Array_obj< ::String >::fromData( _hx_array_data_a82454c0_13,3);
            		}
HXLINE( 254)		return ::polymod::PolymodConfig_obj::modIgnoreFiles;
            	}
...
bool PolymodConfig_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	case 12:
		...
		if (HX_FIELD_EQ(inName,"useHScriptEX") ) { outValue = ( inCallProp == ::hx::paccAlways ? get_useHScriptEX() : useHScriptEX ); return true; }
		break;
	case 13:
	...
	case 16:
		...
		if (HX_FIELD_EQ(inName,"get_useHScriptEX") ) { outValue = get_useHScriptEX_dyn(); return true; }
		break;
	case 17:
...
bool PolymodConfig_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	...
	case 12:
		...
		if (HX_FIELD_EQ(inName,"useHScriptEX") ) { useHScriptEX=ioValue.Cast<  ::Dynamic >(); return true; }
		break;
	case 13:
...
static ::hx::StaticInfo PolymodConfig_obj_sStaticStorageInfo[] = {
	...
	{::hx::fsObject /*  ::Dynamic */ ,(void *) &PolymodConfig_obj::useHScriptEX,HX_("useHScriptEX",7f,3a,f8,15)},
...
static void PolymodConfig_obj_sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(PolymodConfig_obj::useHScriptEX,"useHScriptEX");
...
static void PolymodConfig_obj_sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(PolymodConfig_obj::useHScriptEX,"useHScriptEX");
...
static ::String PolymodConfig_obj_sStaticFields[] = {
	...
	HX_("useHScriptEX",7f,3a,f8,15),
	HX_("get_useHScriptEX",08,27,97,1a),
...
{
{
            	HX_STACKFRAME(&_hx_pos_cae42745e4bfdcf9_138_boot)
HXDLIN( 138)		apiVersionMatch = null();
            	}
{
            	HX_STACKFRAME(&_hx_pos_cae42745e4bfdcf9_156_boot)
HXDLIN( 156)		useHScriptEX = null();
            	}
}
