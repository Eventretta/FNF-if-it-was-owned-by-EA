...
HXLINE(  29)		if (::hx::IsNull( ::flixel::FlxG_obj::save->data->__Field(HX_("etternaMode",88,13,b2,ac),::hx::paccDynamic) )) {
HXLINE(  30)			::flixel::FlxG_obj::save->data->__SetField(HX_("etternaMode",88,13,b2,ac),false,::hx::paccDynamic);
            		}
HXLINE(  32)		if (::hx::IsNull( ::flixel::FlxG_obj::save->data->__Field(HX_("fps",e9,c7,4d,00),::hx::paccDynamic) )) {
HXLINE(  33)			::flixel::FlxG_obj::save->data->__SetField(HX_("fps",e9,c7,4d,00),false,::hx::paccDynamic);
            		}
HXLINE(  35)		if (::hx::IsNull( ::flixel::FlxG_obj::save->data->__Field(HX_("changedHit",bf,5d,c0,31),::hx::paccDynamic) )) {
HXLINE(  37)			::flixel::FlxG_obj::save->data->__SetField(HX_("changedHitX",b9,a9,91,56),-1,::hx::paccDynamic);
HXLINE(  38)			::flixel::FlxG_obj::save->data->__SetField(HX_("changedHitY",ba,a9,91,56),-1,::hx::paccDynamic);
HXLINE(  39)			::flixel::FlxG_obj::save->data->__SetField(HX_("changedHit",bf,5d,c0,31),false,::hx::paccDynamic);
            		}
HXLINE(  42)		if (::hx::IsNull( ::flixel::FlxG_obj::save->data->__Field(HX_("fpsRain",dd,e5,17,c7),::hx::paccDynamic) )) {
HXLINE(  43)			::flixel::FlxG_obj::save->data->__SetField(HX_("fpsRain",dd,e5,17,c7),false,::hx::paccDynamic);
            		}
HXLINE(  45)		if (::hx::IsNull( ::flixel::FlxG_obj::save->data->__Field(HX_("fpsCap",a9,7b,7e,91),::hx::paccDynamic) )) {
HXLINE(  46)			::flixel::FlxG_obj::save->data->__SetField(HX_("fpsCap",a9,7b,7e,91),120,::hx::paccDynamic);
            		}
HXLINE(  48)		bool _hx_tmp;
HXDLIN(  48)		if (!(::hx::IsGreater( ::flixel::FlxG_obj::save->data->__Field(HX_("fpsCap",a9,7b,7e,91),::hx::paccDynamic),285 ))) {
HXLINE(  48)			_hx_tmp = ::hx::IsLess( ::flixel::FlxG_obj::save->data->__Field(HX_("fpsCap",a9,7b,7e,91),::hx::paccDynamic),60 );
            		}
            		else {
HXLINE(  48)			_hx_tmp = true;
            		}
HXDLIN(  48)		if (_hx_tmp) {
HXLINE(  49)			::flixel::FlxG_obj::save->data->__SetField(HX_("fpsCap",a9,7b,7e,91),120,::hx::paccDynamic);
            		}
HXLINE(  51)		if (::hx::IsNull( ::flixel::FlxG_obj::save->data->__Field(HX_("scrollSpeed",3a,e0,46,cb),::hx::paccDynamic) )) {
HXLINE(  52)			::flixel::FlxG_obj::save->data->__SetField(HX_("scrollSpeed",3a,e0,46,cb),1,::hx::paccDynamic);
            		}
HXLINE(  54)		if (::hx::IsNull( ::flixel::FlxG_obj::save->data->__Field(HX_("npsDisplay",51,08,e2,23),::hx::paccDynamic) )) {
HXLINE(  55)			::flixel::FlxG_obj::save->data->__SetField(HX_("npsDisplay",51,08,e2,23),false,::hx::paccDynamic);
            		}
HXLINE(  57)		::hx::TCast<  ::Main >::cast(::openfl::Lib_obj::get_current()->getChildAt(0))->setFPSCap(( (Float)(::flixel::FlxG_obj::save->data->__Field(HX_("fpsCap",a9,7b,7e,91),::hx::paccDynamic)) ));
            	}
