...
HX_DEFINE_STACK_FRAME(_hx_pos_073f38f294c4fadc_116_new,"AccuracyOption","new",0x53bf62a0,"AccuracyOption.new","Options.hx",116,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_073f38f294c4fadc_121_press,"AccuracyOption","press",0x7bacf5c3,"AccuracyOption.press","Options.hx",121,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_073f38f294c4fadc_129_updateDisplay,"AccuracyOption","updateDisplay",0x7ea97179,"AccuracyOption.updateDisplay","Options.hx",129,0x9d9a0240)

void AccuracyOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_073f38f294c4fadc_116_new)
HXLINE( 117)		super::__construct();
HXLINE( 118)		this->description = desc;
            	}
...
bool AccuracyOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_073f38f294c4fadc_121_press)
HXLINE( 122)		::flixel::FlxG_obj::save->data->__SetField(HX_("accuracyDisplay",09,75,5e,26),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("accuracyDisplay",09,75,5e,26),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 123)		this->display = this->updateDisplay();
HXLINE( 124)		return true;
            	}


::String AccuracyOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_073f38f294c4fadc_129_updateDisplay)
HXDLIN( 129)		::String _hx_tmp;
HXDLIN( 129)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("accuracyDisplay",09,75,5e,26),::hx::paccDynamic)) ))) {
HXDLIN( 129)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 129)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 129)		return (HX_("Accuracy ",a7,4b,73,6e) + _hx_tmp);
            	}
