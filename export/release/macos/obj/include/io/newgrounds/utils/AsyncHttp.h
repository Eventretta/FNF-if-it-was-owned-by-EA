...
class HXCPP_CLASS_ATTRIBUTES AsyncHttp_obj : public ::hx::Object
{
	...
	public:
		...
		void __construct( ::Dynamic logVerbose);
		...
		static ::hx::ObjectPtr< AsyncHttp_obj > __new( ::Dynamic logVerbose);
		static ::hx::ObjectPtr< AsyncHttp_obj > __alloc(::hx::Ctx *_hx_ctx, ::Dynamic logVerbose);
		static void * _hx_vtable;
		static Dynamic __CreateEmpty();
		static Dynamic __Create(::hx::DynamicArray inArgs);
		static void __alloc_dynamic_functions(::hx::Ctx *_hx_alloc,AsyncHttp_obj *_hx_obj);
		//~AsyncHttp_obj();
		...
		static void __boot();
		static void getText(::String path, ::Dynamic onData, ::Dynamic onError, ::Dynamic onStatus);
		static ::Dynamic getText_dyn();

		static void send(::String path,::String data, ::Dynamic onData, ::Dynamic onError, ::Dynamic onStatus);
		static ::Dynamic send_dyn();

		static  ::sys::Http sendSync(::String path,::String data, ::Dynamic onData, ::Dynamic onError, ::Dynamic onStatus);
		static ::Dynamic sendSync_dyn();

		static  ::haxe::ds::IntMap _map;
		static  ::haxe::Timer _timer;
		static int _count;
		static void sendAsync(::String path,::String data, ::Dynamic onData, ::Dynamic onError, ::Dynamic onStatus, ::Dynamic logVerbose);
		...
		void start(::String path,::String data, ::Dynamic onData, ::Dynamic onError, ::Dynamic onStatus);
		::Dynamic start_dyn();
		...
		::Dynamic logVerbose;
		inline ::Dynamic &logVerbose_dyn() {return logVerbose; }
