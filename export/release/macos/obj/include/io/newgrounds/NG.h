...
class HXCPP_CLASS_ATTRIBUTES NG_obj : public  ::io::newgrounds::NGLite_obj
{
	...
	public:
		...
		::Dynamic get_passportUrl_dyn();
		 ...
		 ::io::newgrounds::utils::RawSaveSlotList saveSlots;
		 ...
		 ::io::newgrounds::utils::Dispatcher onSaveSlotsLoaded;
		bool loggedIn;
		...
		void requestSaveSlots(::hx::Null< bool >  loadFiles, ::Dynamic callback);
		::Dynamic requestSaveSlots_dyn();
