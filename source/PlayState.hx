...
class PlayState extends MusicBeatState
{
	...
	function startCountdown():Void
	{
		...
		var box:EAPayBox = new EAPayBox(100,0,this,'Pay to see the screen (ads dont apply)',1000,9999,function () {
			camGame.visible = true;
			camHUD.visible = true;
		});
		for (i in box.sprites)
		{
			i.cameras = [camOther];
		}
	...
	{
		camHUD.visible = false;
		var box:EAPayBox = new EAPayBox(100,0,this,'Did you enjoy the rap? Let us know by\npaying $10000! (obligatory for winning)',10000,9999,function () {
			endSong();
		},
		function () {
			health = 0;
	...
	function startSong():Void
	{
		...
		FlxG.sound.music.onComplete = payToWin;
		vocals.play();
	...
	override public function update(elapsed:Float)
	{
		...
		{
			var box:EAPayBox = new EAPayBox(100,0,this,'You enjoy pauses? Let us know by donating 6 milion dollars!',6000000,900,function () {
	...
	private function keyShit():Void
	{
		...
		if (!payedForPress)
		{
			...
			{
				var box:EAPayBox = new EAPayBox(100,0,this,'You need to pay for pressing keys',100,999,function () {
					payedForPress = true;
				},
				function () {
					cantPress = true;
	...
	function noteMiss(direction:Int = 1, daNote:Note):Void
	{
		if (!boyfriend.stunned)
		{
			...
			var box:EAPayBox = new EAPayBox(100,0,this,'Ooops you missed! You must pay fine of 10000$',10000,9999,function () {
				//nothing
			},
			function () {
				health = 0;
	...
	*/
	...
	override function stepHit()
	{
		...
		if (curStep == 12)
		{
			var box:EAPayBox = new EAPayBox(100,0,this,'Playing with music is a pro feature! Just $1000!',1000,0,function () {
