...
class EASubPayBox
{
    ...
    public function new(genX:Int,genY:Int,instance:MusicBeatSubstate,message:String = 'test',costAccept:Int,costDecline:Int,?acceptCallback:Void->Void,?declineCallback:Void->Void) 
    {
